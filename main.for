...
c
      ui_run = 0
      open(unit=22,file='wepp_ui.txt',status='old',err=401)
      ui_run = 1
      write(6,4001)
      close(22)
      goto 402
...
c
 ...
 2800 format (/,' Hillslope ',i4,' SUCCESSFUL simulation'/)
 ...
 3400 format (' *** NOTE ***',/,' Y OR N FOR EXISTING PASS FILE',/,
     1    ' N assumed',/,' *** NOTE ***',/)
 4001 format (//'->WEPP hourly water seepage update set (UI code)'//)   
      end
